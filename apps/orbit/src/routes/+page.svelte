<script lang="ts">
	...
	import AccelerationSystem from '../lib/ecs/systems/AccelerationSystem.svelte';
	import NBodySystem from '../lib/ecs/systems/NBodySystem.svelte';
	import TrailSystem from '../lib/ecs/systems/TrailSystem.svelte';
	import RenderNameSystem from '../lib/ecs/systems/RenderNameSystem.svelte';
	...
	const entityArray: Entity[] = [
		...
		createEntity([
			new NameComponent('Planet'),
			new MassComponent(2),
			new PositionComponent(-1.574871406752105, -1.595455041953879, -0.01515164037265145),
			new VelocityComponent(-4.9225288800471425, -1.5065904473191791, -0.1524041758922603),
			new AccelerationComponent(0, 0),
			new PerviousPositionsComponent(50, 4)
		])
